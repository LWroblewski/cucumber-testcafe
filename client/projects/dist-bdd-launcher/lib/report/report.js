...
const report_config_model_1 = require("./report-config.model");
const reporter = require('cucumber-html-reporter');
const args = Object.assign({}, report_config_model_1.defaultReportingConfiguration, require('yargs').argv);
reporter.generate({
    theme: 'foundation',
